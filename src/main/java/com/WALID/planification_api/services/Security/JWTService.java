...
public class JWTService {
	...
	private String secretkey = "TmV3U2VjcmV0S2V5Rm9ySldUU2lnbmF0dXJlUGxhbmlmaWNhdGlvbkFQSVlvdXNzZWZGYXRpaCMyMDI2";

	public JWTService() {
		// Key generation removed to use a static secret key across application
		// restarts.
	}
