...
public class VillesController {
    ...
    {
    	//if(villesDTO.getStatut().equals(GlobalConstant.STATUT_INACTIF) && (villesDTO.getMotif().isEmpty() || villesDTO.getMotif() == null))
    	//{
    	//	ResponseEntity.status(GlobalConstant.HTTPSTATUT_RESPONSE_ERORR) .body(new MessageResponse("Veuillez entrer un motif pour ce statut.", "warning"));	
    	//}
